...
`git clone` করলে ফাইলটি `~/my-banner/` ফোল্ডারের ভিতরে থাকে, তাই `.bashrc` ফাইলে এই লাইনটা যোগ করো (ফোল্ডারের পাথসহ):

```bash
echo 'python ~/my-banner/mehidi_banner.py' >> ~/.bashrc
```

এরপর Termux বন্ধ করে আবার খুললেই ব্যানারটি নিজে থেকে দেখাবে।

**টার্মিনাল থেকে Termux এর ডিফল্ট welcome message (Docs/Donate/Community info) সরাতে চাইলে:**
